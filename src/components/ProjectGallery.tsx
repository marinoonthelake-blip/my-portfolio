      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {projects.map((p) => (
          <button
            ...
            className="group flex flex-col items-start p-6 border border-gray-800 bg-[#111] hover:border-[#0070F3] transition-colors text-left w-full"
          >
            <span className="text-xs font-mono text-[#0070F3] mb-2">
              {p.category}
            </span>
            <h3 className="text-xl font-bold text-white mb-2 group-hover:text-[#0070F3] transition-colors">
              {p.title}
            </h3>
