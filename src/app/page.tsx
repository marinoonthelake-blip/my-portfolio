...
// ... (Keep projectData and careerData arrays same as before) ...
// 1. Project Data
const projectData = [
  {
    id: "slide-sense",
...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col bg-[#050505] overflow-x-hidden">
      ...
      <div className="w-full min-h-[90vh] flex flex-col md:flex-row items-center justify-center px-[24px] md:px-[64px] pt-20 md:pt-0">
        
        {/* Left Col: Text Strategy */}
        <div className="w-full md:w-1/2 z-10">
           <Hero /> 
        </div>

        {/* Right Col: The Thinking Brain */}
        <div className="w-full md:w-1/2 h-[500px] md:h-auto relative flex items-center justify-center">
           <div className="w-full max-w-lg">
              <ConstellationWrapper />
           </div>
           
           {/* Optional: Background Glow for the Brain */}
      ...
      <section className="w-full max-w-6xl mx-auto px-[24px] md:px-[64px] py-20 bg-[#050505]">
      ...
      <section className="w-full max-w-4xl mx-auto px-[24px] md:px-[64px] pb-20 bg-[#050505]">
        <h2 className="text-2xl font-sans font-bold text-white mb-12 border-b border-gray-800 pb-4">
          Command Log
        </h2>
